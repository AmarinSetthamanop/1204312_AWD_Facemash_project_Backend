...
//========================================================= api random รูปภาพมา 2 รูปภาพ เพื่อรอการ vote เมื่อเปิดหน้า Vote Page ครั้งแรก --> http://127.0.0.1:3000/photo/randomPhoto
            ...
            if (error) {
                ...
                connection.query(sql, (error, result) => {
                    if (error) {
                        ...
                        response.status(200).json({ result : [photo_1, photo_2]});
                    }
                });
            };
        });
