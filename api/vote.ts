...
router.post('/votePhoto', async (request, response) => {
    try {
        ...
        //===================================================================== ตอบกลับ json โดยส่ง ข้อมูลการ update score ของทั้ง 2 รูปที่เคยแข่งกันมาก่อน และ รูปภาพเดิมที่ชนะ กับรูปภาพใหม่ที่ได้จากการสุ่ม (เพราะรูปภาพก่อนหน้านี้แพ้จากการแข่งขั้น จึงต้องสุ่มใหม่)
